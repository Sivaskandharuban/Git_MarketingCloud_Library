...
class mcGenericMethods {
    getOAuthAccessToken(clientId, clientSecret, grantType, code, redirect_uri, tssd) {
    ...
    getApplicationUserInformation(tssd, authToken) {
        return __awaiter(this, void 0, void 0, function* () {
            let self = this;
            let userInfoUrl = "https://" + tssd + ".auth.marketingcloudapis.com/v2/userinfo";
            let headers = {
                "Content-Type": "application/json",
    ...
    dataExtensionCheck(soapInstance, oauthToken, dataExtensionName) {
            ...
            (0, axios_1.default)({
                ...
                parser.parseString(response.data, (err, result) => {
                    ...
                    if (DomainConfiguration != undefined) {
                        ...
                        this.creatingDataExtension(req, res, req.body.memberid, req.body.soapInstance, refreshTokenbody, req.body.FolderID, req.body.tssd);
                    }
                });
            })
                .catch((error) => {
    ...
    creatingDataExtension(req, res, member_id, soap_instance_url, refreshToken, FolderID, tssd) {
        ...
        this.getRefreshTokenHelper(refreshToken, tssd, false, res)
            .then((response) => {
            Utils.logInfo("creatingDomainConfigurationDE:" +
                JSON.stringify(response.refreshToken));
            Utils.logInfo("creatingDomainConfigurationDE:" + JSON.stringify(response.oauthToken));
            refreshTokenbody = response.refreshToken;
            Utils.logInfo("creatingDomainConfigurationDE1:" + JSON.stringify(refreshTokenbody));
